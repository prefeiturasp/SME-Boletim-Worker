...
{
    public class PublicarFilaRabbitSerapEstudanteCommandHandler : IRequestHandler<PublicarFilaRabbitSerapEstudanteCommand, bool>
    {
        private readonly IChannel channel;
        private readonly IServicoLog servicoLog;

        public PublicarFilaRabbitSerapEstudanteCommandHandler(IChannel channel, IServicoLog servicoLog)
        {
            this.channel = channel ?? throw new ArgumentNullException(nameof(channel));
            this.servicoLog = servicoLog ?? throw new ArgumentNullException(nameof(servicoLog));
        }

        public async Task<bool> Handle(PublicarFilaRabbitSerapEstudanteCommand request, CancellationToken cancellationToken)
        {
            try
            {
            ...
            {
                servicoLog.Registrar(LogNivel.Critico, $"Erro: PublicarFilaRabbitSerapEstudanteCommand -- {ex.Message}",
